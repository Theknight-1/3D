...
var clutter = "";
var h1TextContent = document.querySelector("#page2>h1").textContent.split(" ");

h1TextContent.forEach(function (dets) {
...
function files(index) {
  var data = `./Magma-main/frames0007.png
...
var clutter = "";
var h1TextContent = document.querySelector("#page4>h1").textContent.split(" ");
...
var clutter = "";
var h1TextContent = document.querySelector("#page6>h1").textContent.split(" ");
